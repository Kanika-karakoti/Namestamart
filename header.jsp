...
<div class="container-fluid text-center"
    ...
    <p align="center"
        style="color: rgb(25, 252, 25); font-weight: bold; margin-top: 5px; margin-bottom: 5px;"
        id="message"></p>
</div>
...
<a class="navbar-brand" href="userHome.jsp">
    <span class="glyphicon glyphicon-home"></span>NamasteMart
</a>
...
<div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a href="userHome.jsp?type=electronics,appliance">
                        Electronics and Appliances
                    </a>
                </li>

                <li>
                    <a href="userHome.jsp?type=fashion">
                        Fashion and Apparel
                    </a>
                </li>

                <li>
                    <a href="userHome.jsp?type=home,kitchen">
                        Home and Kitchen
                    </a>
                </li>

                <li>
                    <a href="userHome.jsp?type=outdoor,fitness">
                        Fitness and Outdoor
                    </a>
                </li>

                <li>
                    <a href="userHome.jsp?type=sports">
...
<li><a href="./LogoutStr">Logout</a></li>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="adminHome.jsp"><span class="glyphicon glyphicon-home"></span> NamasteMart Admin</a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="adminTrans.jsp">Transactions</a></li>
                <li><a href="./LogoutStr">Logout</a></li>
            </ul>
        </div>
    </div>
