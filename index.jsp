...
<div class="text-center" id="message" style="color: black; font-size: 14px; font-weight: bold;"><%=message%></div>
    ...
    %>
        <div class="col-sm-4" style="height: 350px;">
            <div class="thumbnail">
                ...
                <p class="productioname"><%=product.getProdName()%></p>
                <%
                String description = product.getProdInfo();
                description = description.substring(0, Math.min(description.length(), 100));
                %>
                <p class="productioninfo"><%=description%>...</p>
